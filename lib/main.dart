  ...
  void _connect() async {
    ...
    if (mounted) {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(
          builder: (context) =>
              WebDashboardScreen(serverUrl: _urlController.text),
        ),
      );
    }
  }
...
class WebDashboardScreen extends StatefulWidget {
  final String serverUrl;
  const WebDashboardScreen({super.key, required this.serverUrl});
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            tooltip: "Voltar para Dashboard Nativo",
            onPressed: () {
              Navigator.of(context).pushReplacement(
                MaterialPageRoute(
                  builder: (context) =>
